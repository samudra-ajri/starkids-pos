        ...
        return (
            <Table.Body key={item._id}>
                <Table.Row>
                    ...
                    <Table.Cell><NumberFormat value={item.price.retail} displayType={'text'} thousandSeparator={true}/></Table.Cell>
                    <Table.Cell><NumberFormat value={item.price.wholesale} displayType={'text'} thousandSeparator={true}/></Table.Cell>
                        ...
                        <Table basic='very' compact>
                            <Table.Header>
                                <Table.Row>
                                    ...
                                    <Table.HeaderCell>Harga Eceran (Rp)</Table.HeaderCell>
                                    <Table.HeaderCell>Harga Grosir (Rp)</Table.HeaderCell>
